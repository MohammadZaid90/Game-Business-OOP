...
{
    public partial class AdminChangePasswordFrm : Form
    {
        public AdminChangePasswordFrm()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textoldName.Text != "" && textoldPassword.Text != "" && textoldRole.Text != "")
            {
                ...
                {
                    if ((textoldRole.Text.ToLower() == "admin" || textoldRole.Text.ToLower() == "client") && textoldName.Text == us.UserName && textoldPassword.Text == us.Password)
                    {
                        NewUN.Visible = true;
                        NewP.Visible = true;
